...
def main():
    ...
    # --- Giải pháp tạm (baseline khả thi): xếp đơn mới bằng cheapest insertion ---
    # Thay toàn bộ khối dưới bằng thuật toán của bạn.
    ...
    print(f'[EVORL] Fitness before: {cost_before:.2f}')
    print()
    print('Route after:', get_route_after(best_chromosome.solution , {}))
    print(f'[EVORL] Fitness after: {best_chromosome.fitness:.2f}')
    print()
    # ====================================================================
