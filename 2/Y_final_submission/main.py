...
def _parse_args():
    parser = argparse.ArgumentParser(description="Run the Top-2 simulator.")
    ...
    parser.add_argument("--seed", type=int, default=0, help="Deterministic simulator seed.")
    parser.add_argument(
        "--stats-file",
...
if __name__ == "__main__":
    ...
    runtime_stats = RuntimeStats(stats_file, algorithm="Top-2", seed=args.seed)
    score_list = []
    failed_instances = []
    for idx in list(Configs.selected_instances or Configs.all_test_instances):
